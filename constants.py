...
rim_h = 10.0 # Rim height [ft]
rim_r = 1.5/2 # Rim radius [ft]
rim_bb_dist = 0.5 # Rim end to backboard distance [ft]

bb_l = 6.0 # Backboard width [ft]
bb_h = 3.5 # Backboard height [ft]
bb_z_bot = 9.0 # Backboard bottom z coord [ft]
bb_z_top = bb_z_bot + bb_h # Backboard top z coord [ft]
bb_x = -rim_r - rim_bb_dist # Backboard x coordinate [ft]

# Ball Properties
ball_r = 29.5 / 12 / (2 * np.pi) # Ball radius (from 29.5" circum) [ft]
ball_m = 0.620 * kg2lb # Weight [lbm]
